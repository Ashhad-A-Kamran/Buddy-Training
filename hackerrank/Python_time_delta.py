...
def time_delta(t1, t2):
    ...
    day_1, day_2 = int(list_1[1]), int(list_2[1])
    year_1, year_2 = list_1[2], list_2[2]
    
    timezone_1, timezone_2 = list_1[-1], list_2[-1]
    ...
    sign1 = 1 if timezone_1[0] == '+' else -1
    sign2 = 1 if timezone_2[0] == '+' else -1

    offset1 = sign1 * (int(timezone_1[1:3]) * 3600 + int(timezone_1[3:]) * 60)
    offset2 = sign2 * (int(timezone_2[1:3]) * 3600 + int(timezone_2[3:]) * 60)


    time_secs_1 = h1 * 3600 + m1 * 60 + s1
    time_secs_2 = h2 * 3600 + m2 * 60 + s2

    total_1 = day_1 * 86400 + time_secs_1 - offset1
    total_2 = day_2 * 86400 + time_secs_2 - offset2
